...
public class TitanPlatformProject implements Project {
    ...
    FileObject getTextFolder(boolean create) {
        FileObject result =
                projectDir.getFileObject(TitanPlatformProjectFactory.PROJECT_DIR);
        if (result == null && create) {
            try {
                result = projectDir.createFolder(TitanPlatformProjectFactory.PROJECT_DIR);
    ...
    private final class DemoCopyOperation implements CopyOperationImplementation {
        ...
        public DemoCopyOperation(TitanPlatformProject project) {
